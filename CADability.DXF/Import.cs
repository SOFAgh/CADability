...
namespace CADability.DXF
{
    ...
    public class Import
    {
        ...
        private IGeoObject CreateArc(Arc arc)
        {
            ...
            //plane.Align(pla, false); // ist das gut???
            ...
            if (start == Math.PI * 2.0 && end == 0.0) sweep = 0.0; // kommt in modena.dxf vor
            // startAngle==endAngle wird hier mal als Vollkreis interpretiert
            // startAngle==endAngle zeigt sich in modena.dxf als NICHTS und nicht als Vollkreis

...
namespace CADability.LinearAlgebra
{
    ...
    public class CholeskyDecomposition
    {
        ...
        /// <exception cref="System.ApplicationException">Matrix is not symmetric positive definite.</exception>
        public Matrix Solve(Matrix B)
        {
            ...
            if (!isspd)
            {
                throw new System.ApplicationException("Matrix is not symmetric positive definite.");
            }
